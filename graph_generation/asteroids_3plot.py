...
def create_three_subplot_figure():
    ...
    for plot_type, ax, title in plot_configs:
        ...
        for entropy_coeff in available_coeffs:
            ...
            if x_vals is not None:
                ...
                x_vals = x_vals * 1024  # Timestep multiplier for Asteroids
        ...
        ax.set_xlim(0, 480000*1024)
        ax.set_ylim(0, 200000)
        ax.set_xticks(np.arange(0, 480001*1024, 1e8))
    ...
    for plot_type_to_aggregate in ["complexity", "entropy"]:
        ...
        x_values = np.arange(common_min_len_for_plot_type) * 1024  # Timestep multiplier for Asteroids
    ...
    ax3.set_xlim(0, 480000*1024)
    ax3.set_ylim(0, 200000)
    ax3.set_xticks(np.arange(0, 480001*1024, 1e8))
    ...
    # Save figure
    plot_filename = f"figures/three_subplot_asteroids_{ENVIRONMENT}.pdf"
