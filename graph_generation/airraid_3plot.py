...
def create_three_subplot_figure():
    ...
    for plot_type, ax, title in plot_configs:
        ...
        for entropy_coeff in available_coeffs:
            ...
            if x_vals is not None:
                ...
                x_vals = x_vals * 1024  # Timestep multiplier for AirRaid
        ...
        ax.set_xlim(0, 200000*1024)
        ax.set_ylim(0, 110000)
        ax.set_xticks(np.arange(0, 200001*1024, 5e7))
    ...
    ax3.set_xlim(0, 200000*1024)
    ax3.set_ylim(0, 110000)
    ax3.set_xticks(np.arange(0, 200001*1024, 5e7))
    ...
    # Save figure
    plot_filename = f"figures/three_subplot_airraid_{ENVIRONMENT}.pdf"
