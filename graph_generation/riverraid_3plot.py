...
def create_three_subplot_figure():
        ...
        for entropy_coeff in available_coeffs:
            ...
            if x_vals is not None:
                ...
                if plot_type == "complexity":
                    ...
                    # label = r"$c_{reg}$ = 0" if entropy_coeff == "0" else f"{entropy_coeff}"
    ...
    for plot_type_to_aggregate in ["complexity", "entropy"]:
        ...
        x_values = np.arange(common_min_len_for_plot_type) * 1024
    ...
    # Create legends
    # Legend for first two plots (entropy coefficients) - position over first two subplots
    # legend1 = fig.legend(all_lines, all_labels, loc='lower center', 
    #                     bbox_to_anchor=(0.375, -0.5), title=r"\n Coeff: $c_{reg}$ ", ncol=len(all_labels))
    ...
    # Save figure
    plot_filename = f"figures/three_subplot_riverraid_{ENVIRONMENT}.pdf"
