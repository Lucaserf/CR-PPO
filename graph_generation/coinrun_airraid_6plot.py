...
ENV_CONFIGS = {
    ...
    "airraid": {
        ...
        "seeds": ["9", "10", "11", "6", "7", "8", "0", "1", "2"],
        "rolling_window": 5000,
        "timestep_multiplier": 1024,
        "xlim": (0, 200000 * 1024),
        "ylim": (0, 110000),
        "xticks": np.arange(0, 200001 * 1024, 5e7),
        "progress_file": "progress.csv",
        "reward_column": "rollout/ep_rew_mean",
        "row_label": "AirRaidNoFrameskip-v4",
        "title": "AirRaid",
    },
}
...
def create_six_subplot_figure():
    """Create a 2x3 subplot figure combining Coinrun (top) and AirRaid (bottom)."""
    ...
    all_lines_bot, all_labels_bot, comp_lines_bot, comp_labels_bot = plot_row(
        fig, axes[1], "airraid", ENV_CONFIGS["airraid"], is_top_row=False
    )
    ...
    # Save figure
    plot_filename = "figures/six_subplot_coinrun_airraid.pdf"
