...
def create_three_subplot_figure():
    ...
    for plot_type, ax, title in plot_configs:
        ...
        for entropy_coeff in available_coeffs:
            ...
            if x_vals is not None:
                ...
                x_vals = x_vals * 1  # No multiplier for CarRacing
        ...
        ax.set_xticks(np.arange(0, 4801, 1000))
    ...
    for plot_type_to_aggregate in ["complexity", "entropy"]:
        ...
        x_values = np.arange(common_min_len_for_plot_type) * 1  # No multiplier for CarRacing
    ...
    ax3.set_xticks(np.arange(0, 4801, 1000))
    ...
    # Save figure
    plot_filename = f"figures/three_subplot_carracing_{ENVIRONMENT}.pdf"
